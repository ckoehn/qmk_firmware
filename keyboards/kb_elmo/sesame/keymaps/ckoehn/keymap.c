...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT_alice(
        ...
        _______, KC_TAB,  KC_Q,    KC_W,    CK_E,    CK_R,    KC_T,    KC_Y,    CK_U,    CK_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_BSLS,
        _______, KC_ESC,  CK_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    CK_SCLN, KC_QUOT,          KC_ENT,
                 KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, _______,
                 KC_LCTL,          KC_LALT,          CK_LSPC,          CK_TAB,  CK_RSPC,          KC_RALT,                   KC_RCTL
    ),
    [_DEV] = LAYOUT_alice(
        ...
        _______, _______, KC_AT,   KC_PIPE, KC_DLR,  KC_AMPR, KC_PERC, KC_GRV,  KC_LCBR, KC_RCBR, KC_UNDS, KC_EQL,  _______,          KC_PGUP,
    ...
    [_MISC] = LAYOUT_alice(
        ...
        _______, _______, CK_AE,   CK_SS,   _______, _______, _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, _______,          _______,
                 _______, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    _______, _______,
